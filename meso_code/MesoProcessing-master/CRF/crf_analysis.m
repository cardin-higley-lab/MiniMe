...
control_m_mean = mean(crf_struct.control_m_locoVisResponses(1,:,:), 3, 'omitnan');
control_m_se = std(crf_struct.control_m_locoVisResponses(1,:,:), 0, 3, 'omitnan')/sqrt(size(crf_struct.control_m_locoVisResponses(1,:,:), 3));

mutant_m_mean = mean(crf_struct.mutant_m_locoVisResponses(1,:,:), 3, 'omitnan');
mutant_m_se = std(crf_struct.mutant_m_locoVisResponses(1,:,:), 0, 3, 'omitnan')/sqrt(size(crf_struct.mutant_m_locoVisResponses(1,:,:), 3));
